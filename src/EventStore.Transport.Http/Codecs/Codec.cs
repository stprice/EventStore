...
namespace EventStore.Transport.Http.Codecs
{
    public static class Codec
    {
        ...
        public static readonly CustomCodec ApplicationXml = new CustomCodec(Xml, ContentType.ApplicationXml, Helper.UTF8NoBom, false, false);
        public static readonly CustomCodec EventXml = new CustomCodec(Xml, ContentType.EventXml, Helper.UTF8NoBom, true, true);
